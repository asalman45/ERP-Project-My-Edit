...
import { TrendingDown, Loader2, AlertCircle, CheckCircle, Info } from "lucide-react";
...
const StockOutModal: React.FC<StockOutModalProps> = ({ isOpen, onClose, onSuccess }) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({
        title: "Success",
        description: `Stock issued successfully. Remaining quantity: ${result.data?.new_quantity || 'N/A'}`,
      });
      ...
      toast({
        title: "Error",
        description: error?.response?.data?.error || error?.message || "Failed to issue stock",
        variant: "destructive",
      });
    } finally {
      setLoading(false);
      ...
      <DialogContent className="max-w-3xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle className="flex items-center gap-2">
            ...
            Stock Out - Issue Materials for Production
          </DialogTitle>
        </DialogHeader>
                ...
                <CardContent className="space-y-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <Textarea
                      ...
                      placeholder="Enter any additional notes about this stock out transaction..."
                      rows={3}
                    />
                  </div>
                </CardContent>
